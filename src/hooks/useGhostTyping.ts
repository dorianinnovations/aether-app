    ...
    const startGhostTyping = () => {
      ...
      const typeChar = () => {
        ...
        if (charIndex < targetText.length) {
          ...
          if (!hasTypo && charIndex > 2 && currentChar !== '_' && shouldMakeTypo()) {
          ...
          } else if (charIndex === 1 || targetText[charIndex - 2] === '_') {
      ...
      const startBackspacing = () => {
        ...
        const backspaceChar = () => {
          ...
          if (currentLength > 0) {
            ...
            let backspaceSpeed;
            if (currentLength > 0 && targetText[currentLength] === '_') {
              backspaceSpeed = TYPING_SPEEDS.BACKSPACE_SPACE + Math.random() * 5;
            } else if (currentLength > 0 && targetText[currentLength - 1] === '_') {
